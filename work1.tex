...
and aerial relaying~\cite{10054151,8438896,9750059}.
...
Despite these advances, conventional optimization-based methods rely on accurate system modeling and suffer from high computational complexity, which limits their applicability in dynamic and uncertain wireless environments.

To overcome the limitations of conventional optimization-based methods, DRL-based approaches have gained increasing attention in UAV-enabled communication networks.
...
an explicit jamming cognition mechanism is introduced to capture the dynamic interference patterns.
By integrating the inferred jamming mode into the  zhuadecision-making process, the proposed framework enables faster adaptation to non-stationary environments.
