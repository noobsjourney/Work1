...
\begin{align}
\gamma_{m,k,n}^{s}&=\frac{\rho_{k,n}[m] P_c h_{C,k,n}^{\mathrm{LoS}}}{\sigma^2 + P_m^b h_{P,k,n}^{\mathrm{NLoS}} + \rho_{J,n}[m] P_J h_{J,k,n}^{\mathrm{LoS}}}, \label{eq:sinr_su} \\
\gamma_{m,j,n}^{p}&=\frac{P_m^b h_{P,j,n}^{\mathrm{NLoS}}}{\sigma^2 + \sum_{k=1}^{K} \rho_{k,n}[m] P_c h_{C,j,n}^{\mathrm{LoS}} + \rho_{J,n}[m] P_J h_{J,j,n}^{\mathrm{LoS}}}, \label{eq:sinr_pu}
\end{align}
\end{subequations}
